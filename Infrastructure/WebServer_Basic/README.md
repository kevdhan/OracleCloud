...
### (3b) Steps:
**(3b.1) Create the Web Server (Under Compute --> Instances)**
...
**(3b.2) Load Balancer (Under Networking --> Load Balancer)**
1. Add Details
...
**(3b.3) Bastion Host – similar process to creating Web Server VM**
...
## (4) Update Security Lists with Security Rules
### (4a) Goal:
...
### (4b) Steps:
**(4b.1) Security List for Public Subnet – Bastion Host**
...
**(4b.2) Security List for Private Subnet – Web Server**
...
**(4b.3) Security List for Public Subnet – Load Balancer**
...
## (5)	SSH into Bastion Host then SSH into Web Server to Install and Configure Apache and PHP
### (5a) Goal:
...
**(5b.2) From Bastion Host, SSH into the Web Server**
...
**(5b.3) Install and Configure Apache**
...
## 6	End
We have successfully created a network that hosts a private Web Server/Application that is accessed through a Public Load Balancer.
